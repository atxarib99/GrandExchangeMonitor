...
class Item {
  ...
  Item(
      ...
      this.ninetyDayTrend,
      this.ninetyDayChange,
      this.oneEightyDayTrend,
      this.oneEightyDayChange,
      this.imageURL);
  ...
  Item.fromJSON(Map<String, dynamic> json)
      : defaultCreation = false,
        ...
        currentPrice =
            parseRuneType(json['item']['current']['price'].toString()),
  ...
  Item.fromDefault()
      : defaultCreation = true,
        id = 13190,
        imageURL =
            "https://secure.runescape.com/m=itemdb_oldschool/1630578602840_obj_big.gif?id=13190",
        type = "Default",
